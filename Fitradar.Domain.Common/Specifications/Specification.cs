...
namespace Fitradar.Domain.Common.Specifications
{
    ...
    /// </remarks>
    public class Specification<T> : ISpecification<T> where T : notnull
    {
        ...
        /// </summary>
        /// <param name="entity">The <typeparamref name="T"/> instance to evaluate the specification
        /// against.</param>
        /// <returns>Should return true if the specification was satisfied by the entity, else false. </returns>
        public bool IsSatisfiedBy(T entity) => _predicateCompiled(entity);
